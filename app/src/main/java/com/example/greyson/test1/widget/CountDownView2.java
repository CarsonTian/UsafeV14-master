...
import com.example.greyson.test1.core.TimerService2;
...
public class CountDownView2 extends RelativeLayout {
    ...
    public CountDownView2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mTimerIntent = new Intent(context, TimerService2.class);
